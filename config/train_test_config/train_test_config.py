...
def draw_pred_XNet(num_classes, mask_train, mask_val, pred_train_sup1, pred_train_sup2, outputs_val1, outputs_val2, train_eval_list1, train_eval_list2, val_eval_list1, val_eval_list2):
    ...
    if num_classes == 2:
        ...
        pred_train_sup1 = torch.softmax(pred_train_sup1, dim=1)
        ...
        pred_train_sup2 = torch.softmax(pred_train_sup2, dim=1)
        ...
        outputs_val1 = torch.softmax(outputs_val1, dim=1)
        ...
        outputs_val2 = torch.softmax(outputs_val2, dim=1)
