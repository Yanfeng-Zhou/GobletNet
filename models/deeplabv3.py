...
def deeplabv3plus_resnet18(in_channels, num_classes, pretrained):
    model = DeepLabV3_plus(num_classes, in_channels, backbone='resnet18', pretrained=pretrained)
    return model

def deeplabv3plus_resnet34(in_channels, num_classes, pretrained):
    model = DeepLabV3_plus(num_classes, in_channels, backbone='resnet34', pretrained=pretrained)
    return model

def deeplabv3plus_resnet50(in_channels, num_classes, pretrained):
    model = DeepLabV3_plus(num_classes, in_channels, backbone='resnet50', pretrained=pretrained)
    return model

def deeplabv3plus_resnet101(in_channels, num_classes, pretrained):
    model = DeepLabV3_plus(num_classes, in_channels, backbone='resnet101', pretrained=pretrained)
    return model

def deeplabv3plus_resnet152(in_channels, num_classes, pretrained):
    model = DeepLabV3_plus(num_classes, in_channels, backbone='resnet152', pretrained=pretrained)
    return model

def deeplabv3plus_xception(in_channels, num_classes, pretrained):
    model = DeepLabV3_plus(num_classes, 3, backbone='xception', pretrained=pretrained)
    if not pretrained or in_channels != 3:
        model.backbone.conv1 = nn.Conv2d(in_channels, 32, 3, 2, padding=1, bias=False)
        initialize_weights(model.backbone.conv1)
    return model


if __name__ == '__main__':
    model = deeplabv3plus_resnet50(1,2, False)
...
# if __name__ == '__main__':
#     model = deeplabv3plus_resnet18(1,10, True)
#     model.eval()
#     input = torch.rand(2,1,128,128)
#     output = model(input)
