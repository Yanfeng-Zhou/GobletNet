...
if __name__ == '__main__':
    ...
    parser.add_argument('--path_dataset', default='.../GobletNet/dataset/Nanowire')
    parser.add_argument('--dataset_name', default='Nanowire', help='EPFL, CREMI, SNEMI3D, UroCell, MitoEM, Nanowire, BetaSeg')
    ...
    data_normalize_LL = data_normalize(cfg['MEAN_LL'], cfg['STD_LL'])
    data_normalize_LH = data_normalize(cfg['MEAN_LH'], cfg['STD_LH'])
    data_normalize_HL = data_normalize(cfg['MEAN_HL'], cfg['STD_HL'])
    data_normalize_HH = data_normalize(cfg['MEAN_HH'], cfg['STD_HH'])
