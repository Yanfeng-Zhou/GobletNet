...
if __name__ == '__main__':
    ...
    parser.add_argument('--input1', default='LL')
    parser.add_argument('--input2', default='H_0.0')
    ...
    parser.add_argument('-n', '--network', default='xnet_v2', type=str)
    ...
    if args.vis and rank == args.rank_index:
        visdom_env = str(str(os.path.split(args.path_dataset)[1]) + '-' + args.network + '-l=' + str(args.lr) + '-e=' + str(args.num_epochs) + '-s=' + str(args.step_size) + '-g=' + str(args.gamma) + '-b=' + str(args.batch_size)+ '-cw=' + str(args.unsup_weight) + '-w=' + str(args.warm_up_duration)+'-'+str(args.input1)+'-'+str(args.input2))
